...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2c, 0x0a, 0x0b, 0x53, 0x75, 0x6d, 0x52,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x4e, 0x0a, 0x12, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x03,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x26, 0x5a, 0x24, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalculatorResponse.Sum:input_type -> calculator.SumRequest
	1, // 1: calculator.CalculatorResponse.Sum:output_type -> calculator.SumResponse
...
// CalculatorResponseClient is the client API for CalculatorResponse service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type CalculatorResponseClient interface {
	Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error)
}

type calculatorResponseClient struct {
	cc grpc.ClientConnInterface
}

func NewCalculatorResponseClient(cc grpc.ClientConnInterface) CalculatorResponseClient {
	return &calculatorResponseClient{cc}
}

func (c *calculatorResponseClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculatorResponse/Sum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// CalculatorResponseServer is the server API for CalculatorResponse service.
type CalculatorResponseServer interface {
	Sum(context.Context, *SumRequest) (*SumResponse, error)
}

// UnimplementedCalculatorResponseServer can be embedded to have forward compatible implementations.
type UnimplementedCalculatorResponseServer struct {
}

func (*UnimplementedCalculatorResponseServer) Sum(context.Context, *SumRequest) (*SumResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sum not implemented")
}

func RegisterCalculatorResponseServer(s *grpc.Server, srv CalculatorResponseServer) {
	s.RegisterService(&_CalculatorResponse_serviceDesc, srv)
}

func _CalculatorResponse_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorResponseServer).Sum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculatorResponse/Sum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorResponseServer).Sum(ctx, req.(*SumRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _CalculatorResponse_serviceDesc = grpc.ServiceDesc{
	ServiceName: "calculator.CalculatorResponse",
	HandlerType: (*CalculatorResponseServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Sum",
			Handler:    _CalculatorResponse_Sum_Handler,
		},
	},
